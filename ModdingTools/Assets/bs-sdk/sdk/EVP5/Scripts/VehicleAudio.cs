...
public class VehicleAudio : MonoBehaviour
{
    ...
    public class Engine
    {
        ...
        [Space(5)] public float idleRpm = 600.0f;
        public float idlePitch = 0.25f;
        public float idleVolume = 0.4f;
        [Space(5)] public float maxRpm = 6000.0f;
        public float maxPitch = 1.5f;
        public float maxVolume = 0.6f;
        [Space(5)] public float throttleRpmBoost = 500.0f;
        public float throttleVolumeBoost = 0.4f;
        [Space(5)] public float wheelsToEngineRatio = 16.0f;
        public int gears = 5;
        public float gearDownRpm = 2500.0f;
        public float gearUpRpm = 5000.0f;
        [Space(5)] public float gearUpRpmRate = 5.0f;
    ...
    public class EngineExtras
    {
        ...
        [Range(0, 3)] public float turboMinPitch = 0.8f;
        [Range(0, 3)] public float turboMaxPitch = 1.5f;
        [Range(0, 1)] public float turboMaxVolume = 1.0f;
        public bool turboRequiresThrottle = true;

        [Space(5)] public AudioClip turboDumpClip;
        ...
        [Space(5)] public AudioSource transmissionAudioSource;
        [Range(0.1f, 1)] public float transmissionMaxRatio = 0.9f; // Ratio of maximum transmission velocity (maxRpm * gearCount) at which transmission is considered maximum
        [Range(0, 3)] public float transmissionMinPitch = 0.2f;
        [Range(0, 3)] public float transmissionMaxPitch = 1.1f;
        [Range(0, 1)] public float transmissionMinVolume = 0.1f;
        [Range(0, 1)] public float transmissionMaxVolume = 0.2f;
    }
    ...
    public class Wheels
    {
        ...
        [Range(0, 3)] public float skidMinPitch = 0.9f;
        [Range(0, 3)] public float skidMaxPitch = 0.8f;
        [Range(0, 1)] public float skidMaxVolume = 0.75f;

        [Space(5)] public AudioSource offroadAudioSource;
        public float offroadMinSpeed = 1.0f;
        public float offroadMaxSpeed = 20.0f;
        [Range(0, 3)] public float offroadMinPitch = 0.3f;
        [Range(0, 3)] public float offroadMaxPitch = 2.5f;
        [Range(0, 1)] public float offroadMinVolume = 0.3f;
        [Range(0, 1)] public float offroadMaxVolume = 0.6f;

        [Space(5)] public AudioClip bumpAudioClip;
        ...
        [Range(0, 1)] public float bumpMinVolume = 0.2f; // Volume to be applied at the minimum bump intensity
        [Range(0, 1)] public float bumpMaxVolume = 0.6f; // Volume to be applied at the maximum bump intensity
    }

    [Serializable]
    public class Impacts
    {
        [Space(5)] public AudioClip hardImpactAudioClip;
        ...
        [Range(0, 3)] public float minPitch = 0.3f; // Pitch to be applied at minimum impact speed
        [Range(0, 3)] public float maxPitch = 0.6f; // Pitch to ba applied at maximum impact speed
        [Range(0, 3)] public float randomPitch = 0.2f; // Random pitch range (+- value) to be added to the pitch
        [Range(0, 1)] public float minVolume = 0.7f; // Volume to be applied at minimum impact speed
        [Range(0, 1)] public float maxVolume = 1.0f; // Volume to be applied at maximum impact speed
        [Range(0, 1)] public float randomVolume = 0.2f; // Random volume range (+- value) to be added to the volume
    }
    ...
    public class Drags
    {
        ...
        [Range(0, 3)] public float minPitch = 0.6f;
        [Range(0, 3)] public float maxPitch = 0.8f;
        [Range(0, 1)] public float minVolume = 0.8f;
        [Range(0, 1)] public float maxVolume = 1.0f;

        [Space(5)] public AudioClip scratchAudioClip;
        ...
        [Range(0, 3)] public float scratchMinPitch = 0.7f;
        [Range(0, 3)] public float scratchMaxPitch = 1.1f;
        [Range(0, 1)] public float scratchMinVolume = 0.9f;
        [Range(0, 1)] public float scratchMaxVolume = 1.0f;
    }
    ...
    public class Wind
    {
        ...
        [Range(0, 3)] public float minPitch = 0.5f;
        [Range(0, 3)] public float maxPitch = 1.0f;
    ...
    [Space(2)] public Engine engine = new Engine();
    [Space(2)] public EngineExtras engineExtras = new EngineExtras();
    [Space(2)] public Wheels wheels = new Wheels();
    [Space(2)] public Impacts impacts = new Impacts();
    [Space(2)] public Drags drags = new Drags();
    [Space(2)] public Wind wind = new Wind();
